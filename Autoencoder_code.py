...
# they are in dictionary data types, which need to be unwrapped in the follwoing. The corresponding labels are not required for this project.
# Because the datasets are in the form of a dictionary including a 4D matrix called X, including 32*32*3 images, they need to be extracted:
images_training = training_dataset.get('X')
images_testing = testing_dataset.get('X')

# The data can also be downloaded through the following codes, just for having on a local machine, not required for this program. 
# =============================================================================
